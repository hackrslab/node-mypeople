...
Receiver.prototype.sendMessage = function(userId, message) {
  this.client.sendMessage(userId, message, function() {
    // TODO: handling
  });
};
...
Group.prototype.sendMessage = function(groupId, message) {
  this.client.sendGroupMessage(groupId, message, function() {
    // TODO: handling
  });
};
